...
pretrain_log_params = {
    ...
    'checkpoint_path': f"../results/{dataset}/{time_context}s_segments/protoeyetcn/cross_validation/",
    'checkpoint_name': "checkpoint_100.pt",
    'results_path': f"../results/{dataset}/{time_context}s_segments/protoeyetcn/cross_validation/",
    }
...
save_path = f"../results/{dataset}/{time_context}s_segments/protoeyetcn/cross_validation/"
path = Path(save_path)
if not path.exists():
    path.mkdir(parents=True, exist_ok=True)
with open(os.path.join(path, 'protoeyetcn_cv_params.json'), 'w') as file:
