# -*- coding: utf-8 -*-
"""
Created on Mon May 27 15:56:19 2024
...
log_params = {
    ...
    'checkpoint_path': f"../results/{dataset}/{time_context}s_segments/eyetcn/single_train_test_split/",
    'checkpoint_name': "checkpoint_100.pt",
    'results_path': f"../results/{dataset}/{time_context}s_segments/eyetcn/single_train_test_split/",
    }
...
save_path = f"../results/{dataset}/{time_context}s_segments/eyetcn/single_train_test_split/"
path = Path(save_path)
if not path.exists():
    path.mkdir(parents=True, exist_ok=True)
with open(os.path.join(path, 'eyetcn_params.json'), 'w') as file:
